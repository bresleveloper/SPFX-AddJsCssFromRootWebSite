...
import * as strings from 'AddCssJsFromRootWebApplicationCustomizerStrings';

const LOG_SOURCE: string = 'AddCssJsFromRootWebApplicationCustomizer';
 ...
 */
export interface IAddCssJsFromRootWebApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class AddCssJsFromRootWebApplicationCustomizer
  extends BaseApplicationCustomizer<IAddCssJsFromRootWebApplicationCustomizerProperties> {
